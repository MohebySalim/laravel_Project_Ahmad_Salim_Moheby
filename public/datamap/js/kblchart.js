(function() {
    var d;
    window.KblChart ? d = window.KblChart : (d = {}, window.KblChart = d, d.themes = {}, d.maps = {}, d.inheriting = {}, d.charts = [], d.onReadyArray = [], d.useUTC = !1, d.updateRate = 60, d.uid = 0, d.lang = {}, d.translations = {}, d.mapTranslations = {}, d.windows = {}, d.initHandlers = [], d.amString = "am", d.pmString = "pm");
    d.Class = function(a) {
        var b = function() {
    ...
    d.getPath = function() {
        ...
        if (a)
            for (var b = 0; b < a.length; b++) {
                var c = a[b].src;
                if (-1 !== c.search(/\/(KblChart|ammap)\.js/)) return c.replace(/\/(KblChart|ammap)\.js.*/,
                    "/")
            }
    };
...
(function() {
    ...
    d.AmChart = d.Class({
        ...
        initChart: function() {
            ...
            window.KblChart_path && (this.path = window.KblChart_path);
            void 0 === this.path && (this.path =
                d.getPath());
            void 0 === this.path && (this.path = "KblChart/");
    ...
    d.AmDraw = d.Class({
        ...
        addDefs: function(a) {
            if (d.hasSVG) {
                ...
                a && (a.addCodeCredits && b.appendChild(document.createTextNode("" + a.version)), a.accessibleDescription && (b.innerHTML = "", b.appendChild(document.createTextNode(a.accessibleDescription))),
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            "outside" ==
            b ? (c = f.offsetWidth, g = f.offsetHeight, f.clientHeight && (c = f.clientWidth, g = f.clientHeight)) : (isNaN(c) || (f.style.width = c + "px"), f.className = "KblChartLegend " + a.classNamePrefix + "-legend-div");
            this.divWidth = c;
